...
if (localStorage.getItem("bestBrain")) {
    ...
    for (let i = 0; i < cars.length; i++) {
        cars[i].brain = JSON.parse(
            //local storage only work with strings, so we need to parse it to string
...
const traffic = [
    ...
    new Car(road.getLaneCenter(1), -740, 30, 50, "DUMMY", 2),
    new Car(road.getLaneCenter(2), -730, 30, 50, "DUMMY", 2),
    ...
    new Car(road.getLaneCenter(1), -1750, 30, 50, "DUMMY", 2),
